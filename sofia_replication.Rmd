...
--- level of consensus among users associated with social influence of the author of the source tweet 
...
why are we doing log reg to predict a continous value ? nothing about this
...
i think also a plot that talks about the characterisitcs of the note that says 